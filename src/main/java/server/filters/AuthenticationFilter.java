package main.java.server.filters;
...
public class AuthenticationFilter implements ContainerRequestFilter {
    ...
    private static final String ignorePaths[] = new String[] {"/login", "/signup", "/visitor", "/admin/students"};
    ...
    public void filter(ContainerRequestContext ctx) throws IOException {
        ...
        if (isPathIgnored(ctx.getUriInfo().getPath())) {
            System.out.println("Ignoring Auth. Path: " + ctx.getUriInfo().getPath());
            return;
        }
